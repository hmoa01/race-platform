        ...
        <div className='max-w-[500px]'>
          ...
          <form className='mt-6'>
            ...
            <div className='mt-[40px] flex justify-between'>
              <Button text='Login' className='flex items-center justify-center h-[50px] w-[180px] rounded-sm bg-[#5ca595] text-[#ffffff] text-[20px]'/>
              <Button text='Sign up' className='flex items-center justify-center h-[50px] w-[180px] rounded-sm border-2 border-solid border-[#5ca595] text-[#5ca595] text-[20px]'/>
            </div>
          </form>
        </div>
      </div>
